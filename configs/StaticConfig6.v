...
`define CLKPERIOD 0.56//6x0.57
//`define CLKPERIOD 10.00 //6x0.57
//`define CLKPERIOD 0.55//6x0.57
...
`define SIZE_ACTIVELIST         160
`define SIZE_ACTIVELIST_LOG     9

`define SIZE_PHYSICAL_TABLE     160
`define SIZE_PHYSICAL_LOG       9
...
`define SIZE_FREE_LIST          (`SIZE_PHYSICAL_TABLE-`SIZE_RMT) // 96
