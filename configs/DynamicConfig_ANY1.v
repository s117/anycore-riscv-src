...
//`define CLKPERIOD 3.84  // 6x0.64
`define CLKPERIOD 8.00 // For Anycore_1 
//`define CLKPERIOD 0.77 // 6x0.64
...
`define SIZE_FREE_LIST          (`SIZE_PHYSICAL_TABLE-`SIZE_RMT) // 94
